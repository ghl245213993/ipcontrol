...
<blockquote class="je-quote je-f14">
    ...
    <div class="je-form-item je-f14 checkbox">
        <?php foreach( $gost_show_list as $v ){ ?>
            <input type="checkbox" name="gostcheckbox" value="<?php echo $v['id'];?>" jename="checkbox" <?php if( $v['is_show'] ){ ?>checked<?php } ?> jetext="<?php echo $v['name'];?>">
        <?php } ?>
    </div>
        <!--</form>-->
