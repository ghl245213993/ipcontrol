    ...
    <table class="je-table je-mb20" id="newCheck">
    	...
    	<?php foreach( $user_list as $v ){ ?>
        	<tr>
                ...
                <td>
                    <input type="radio" name="radioswitch<?php echo $v['id'];?>" value="<?php echo $v['id'];?>:1" small jename="switch" <?php if( $v['admin'] == 1 ){ ?>checked<?php } ?> jetext="超级管理员,超级管理员">
                    <input type="radio" name="radioswitch<?php echo $v['id'];?>" value="<?php echo $v['id'];?>:0" small jename="switch" <?php if( $v['admin'] == 0 ){ ?>checked<?php } ?> jetext="管理员,管理员">
                    <input type="radio" name="radioswitch<?php echo $v['id'];?>" value="<?php echo $v['id'];?>:-1" small jename="switch" <?php if( $v['admin'] == -1 ){ ?>checked<?php } ?> jetext="用户,用户">
                </td>
	            <td align="center">
