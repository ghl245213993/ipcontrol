...
<div class="je-p20">
        ...
        <!--<form id="itemcheac">-->
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" id="remote_cname" autocomplete="off" placeholder="选填" class="je-input">
                </div>
            </div>
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" id="remote_ip" autocomplete="off" placeholder="选填" class="je-input">
                </div>
            </div>

            <div class="je-form-item">
                <label class="je-label je-f14">本地网卡IP</label>
                <div class="je-inputbox">
                    <input type="text" id="local_ip" autocomplete="off" placeholder="选填（覆盖服务器网卡IP设置）" class="je-input">
                </div>
            </div>
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" <?php if( $user['admin']==-1 ){ ?>disabled<?php } ?> id="limit_speed" autocomplete="off" placeholder="0为不限速，默认为0。" class="je-input">
                </div>
            </div>
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" <?php if( $user['admin']==-1 ){ ?>disabled<?php } ?> id="traffic_all" autocomplete="off" placeholder="0为不限制流量，默认为0。" class="je-input">
                </div>
            </div>
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" <?php if( $user['admin']==-1 ){ ?>disabled<?php } ?> id="reset_day" autocomplete="off" placeholder="0为不统计流量，默认为1" class="je-input">
                </div>
            </div>
