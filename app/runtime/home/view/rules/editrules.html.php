...
<div class="je-p20">
        ...
        <!--<form id="itemcheac">-->
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" id="local_ip" autocomplete="off" value="<?php echo $rule['local_ip'];?>" placeholder="选填（覆盖服务器网卡IP设置）" class="je-input">
                </div>
            </div>
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" <?php if( $user['admin']==-1 ){ ?>disabled<?php } ?> id="limit_speed" autocomplete="off" value="<?php echo $rule['limit_speed'];?>" class="je-input">
                </div>
            </div>
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" <?php if( $user['admin']==-1 ){ ?>disabled<?php } ?> id="traffic_all" autocomplete="off" value="<?php echo toGb($rule['traffic_all']); ?>" placeholder="设置流量上限，默认为0。" class="je-input">
                </div>
            </div>
            ...
            <div class="je-form-item">
                ...
                <div class="je-inputbox">
                    <input type="text" <?php if( $user['admin']==-1 ){ ?>disabled<?php } ?> id="reset_day" autocomplete="off" value="<?php echo $rule['reset_day'];?>" placeholder="输入为0则不启用，默认为0." class="je-input">
                </div>
            </div>
